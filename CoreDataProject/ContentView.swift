...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            FilteredList(sortDescriptors: [SortDescriptor<Friend>(\.lastName, order: .reverse)], filterKey: "firstName", filterValue: firstNameFilter, pradicate: .beginsWith) { (friend: Friend) in
